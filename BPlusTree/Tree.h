...
protected:	
	...
	/**
	 * @brief search a value in btree
	 *
	 * @param root: tree root
	 * @param target: target to search
	 *
	 * @return: whether is exist
	 */
	virtual bool btree_search(btree_node *root, int target)=0;
	...
	virtual void del_tree(btree_node *root) = 0;
